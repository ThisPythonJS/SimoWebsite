...
export const Header: React.FC = () => {
    ...
    return (
        <>
            <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full md:w-[95%] max-w-6xl z-50 bg-[#0c0e12]/90 backdrop-blur-md border border-white/10 rounded-b-2xl px-5 py-3 flex items-center justify-between shadow-lg transition-all duration-300">
